<?php
$all_days = array(
  'sunday' => esc_html('Dimanche', 'default'),
  'monday' => esc_html('Lundi', 'default'),
  'tuesday' => esc_html('Mardi', 'default'),
  'wednesday' => esc_html('Mercredi', 'default'),
  'thursday' => esc_html('Jeudi', 'default'),
  'friday' => esc_html('Vendredi', 'default'),
  'saturday' => esc_html('Samedi', 'default'),
);
        ...
        <div class="wclp_location_box_content">
          ...
          ?>
                <p class="wclp_work_hours_p">
                  <?php
                  echo esc_html_e(slug_to_date(key($data)), 'zorem-local-pickup') . ' <span>: ' . esc_html(reset($data)['wclp_store_hour']) . ' - ' . esc_html(reset($data)['wclp_store_hour_end']);
            ...
            ?>
                <p class="wclp_work_hours_p">
                  <?php
                  echo esc_html_e(slug_to_date($array_key_first), 'zorem-local-pickup') . esc_html_e(' et ') . esc_html_e(slug_to_date($array_key_last), 'zorem-local-pickup') . ' <span>: ' . esc_html(reset($data)['wclp_store_hour']) . ' - ' . esc_html(reset($data)['wclp_store_hour_end']);
                  do_action('wclp_get_more_work_hours_contents', $data);
                  echo '</span>';
                  ?>
                </p>
            ...
            ?>
                <p class="wclp_work_hours_p">
                  <?php
                  echo esc_html_e(slug_to_date($array_key_first), 'zorem-local-pickup') . esc_html_e(' à ', 'zorem-local-pickup') . esc_html_e(slug_to_date($array_key_last), 'zorem-local-pickup') . ' <span>: ' . esc_html(reset($data)['wclp_store_hour']) . ' - ' . esc_html(reset($data)['wclp_store_hour_end']);
                  do_action('wclp_get_more_work_hours_contents', $data);
                  echo '</span>';
                  ?>
                </p>
